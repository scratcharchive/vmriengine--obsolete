#ifndef vmrigpuinterface_H
#define vmrigpuinterface_H

#include <QList>

class VmriGpuInterfacePrivate;
class VmriGpuInterface {
public:
	friend class VmriGpuInterfacePrivate;
	
	VmriGpuInterface();
	virtual ~VmriGpuInterface();
